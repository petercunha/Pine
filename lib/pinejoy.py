...
def start(ENABLE_AIMBOT):
    ...
    minPixelValue = -960
    maxPixelValue = 960
    minAxisValue = 341328125
    minPixelValue1 = -960
    maxPixelValue1 = 960
    minAxisValue1 = 341328125
            ...
            if not skipRound:
                for i in idxs.flatten():
                    ...
                    if ENABLE_AIMBOT and bestMatch == confidences[i]:
                        ...
                        distPixel = maxPixelValue - minPixelValue
                        distAxis = maxAxisValue - minAxisValue
                        axisPerPixel = distAxis / distPixel
                        axisDelta = mouseX * axisPerPixel
                        distPixel1 = maxPixelValue1 - minPixelValue1
                        distAxis1 = maxAxisValue1 - minAxisValue1
                        axisPerPixel1 = distAxis1 / distPixel1
                        axisDelta1 = mouseY * axisPerPixel1
                        j.set_axis(HID_USAGE_X, axisDelta)
                        j.set_axis(HID_USAGE_X, axisDelta1)
